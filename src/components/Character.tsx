    ...
    <TooltipProvider>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Let&apos;s come up with a character! Leave the fields blank to
            generate details, or fill in properties and check them to set them.
            Press the save button to save the character to your gallery.
          </CardDescription>
        </CardHeader>
        ...
        <CardFooter className="gap-4 justify-center mt-12 flex flex-col md:flex-row">
          ...
          <Tooltip delayDuration={300}>
            ...
            <TooltipContent className="w-80 p-2">
              <p>
                Type in a prompt to generate an entity. Additionally, pick a
                Context Entity from the contextualize button to reference it in
                your generation. Combine the two to generate a character with
                depth and purpose. Then, save it to your gallery!
              </p>
            </TooltipContent>
          </Tooltip>
        </CardFooter>
