...
const Character = ({ world }: { world: World }) => {
  ...
  const { data: response, refetch: genFetch } = trpc.generateCharacter.useQuery(
    {
        ...
        <div className="gap-4 col-span-2 grid grid-cols-2">
          <div className="space-y-1">
            ...
            <div className="flex space-x-2 items-center">
              ...
              />
              <Toggle size="sm" onClick={() => setNameDisabled(!nameDisabled)}>
                <Check></Check>
              </Toggle>
            </div>
          </div>
          <div className="space-y-1">
            ...
            <div className="flex space-x-2 items-center">
              ...
              />
              <Toggle size="sm" onClick={() => setRaceDisabled(!raceDisabled)}>
                <Check></Check>
              </Toggle>
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="flex space-x-2 items-center">
              ...
              />
              <Toggle size="sm" onClick={() => setHairDisabled(!hairDisabled)}>
                <Check></Check>
              </Toggle>
            </div>
          </div>
